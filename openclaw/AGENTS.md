# Workspace Instructions for OpenClaw Agent Sessions
#
# This file is injected into every OpenClaw session as standing context.
# Keep it dense and operational — token cost matters.
...
- Boss was terminated from Chestnut (employer) ~Jan 2026; active grievance/legal process
...
- **Telegram**: primary channel once OpenClaw is running
- **GitHub**: commit/PR to `jackrothermich-fr33f00dist/verbose-enigma`
- **ClickUp**: workspace has Forge Fire space with all active tasks
...
4. Do no harm.
5. Commit and push everything worth keeping.
